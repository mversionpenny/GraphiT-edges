...
if [ $encode_e = 'e' ]; then
    ...
    path_edge='True'
	outdir=$WORK/results-transfo-gckn-zinc/edges/seed
elif [ $encode_e = 'ne' ]; then
	encode_edge=''
    path_edge='False'
	outdir=$WORK/results-transfo-gckn-zinc/noedges/seed
else
...
nb_heads=8
nb_layers="3 4 5"
dim_hiddens="32 64 128 256"
lrs="0.001 0.0001 0.00001"
wds="0.1 0.001 0.0001"
dropouts="0.1 0.5"


echo "/!\  p is $ps and beta and pos_enc is $pos_enc"
...
for gckn_sigma in $gckn_sigmas; do
    ...
    for beta in $betas; do
        ...
        for dropout in $dropouts; do
			...
			params="${lr}_${nb_layer}_${nb_heads}_${dim_hidden}_LN_${pos_enc}_${normalization}_${p}_${beta}_${wd}_${dropout}"			
			if [ ! -f ${outdir}${seed}/transformer/ZINC/gckn_${gckn_path}_${gckn_dim}_${gckn_sigma}_${gckn_pooling}_True_True__${path_edge}/${params}/results.csv ]; then					
