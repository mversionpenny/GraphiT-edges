...
for gckn_sigma in $gckn_sigmas; do
    ...
    for beta in $betas; do
        ...
        for dropout in $dropouts; do
			...
			if [ ! -f ${outdir}${seed}/transformer/ppa/${edge_attr}/gckn_${gckn_path}_${gckn_dim}_${gckn_sigma}_${gckn_pooling}_True_True_${path_edge}/${params}/results.csv ]; then					
