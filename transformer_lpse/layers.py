...
def diff_multi_head_attention_forward(query,
    ...
    # En fait ca serait ici qu'il faudrait un attn_output_weights_op et faire :
    # attn_output_weights = attn_output_weights + attn_output_weights_op
    return attn_output_weights, v, bsz, num_heads, tgt_len, head_dim, out_proj_weight, out_proj_bias, embed_dim, src_len
